...
open class SudoEntitlementsAdminException(
    message: String? = null,
    ...
    companion object {
         ...
         */
        fun sudoEntitlementsAdminException(
            errorString: String,
            message: String? = errorString,
        ): SudoEntitlementsAdminException =
            when (errorString) {
                ...
                GRAPHQL_ERROR_DECODING_ERROR, GRAPHQL_ERROR_INVALID_ARGUMENT_ERROR ->
                ...
                GRAPHQL_ERROR_ENTITLEMENTS_SET_NOT_FOUND_ERROR ->
                    EntitlementsSetNotFoundException(
                        message,
                    )
                GRAPHQL_ERROR_ENTITLEMENTS_SET_ALREADY_EXISTS_ERROR ->
                    EntitlementsSetAlreadyExistsException(
                        message,
                    )
                GRAPHQL_ERROR_ENTITLEMENTS_SEQUENCE_ALREADY_EXISTS_ERROR ->
                    EntitlementsSequenceAlreadyExistsException(
                        message,
                    )
                GRAPHQL_ERROR_ENTITLEMENTS_SEQUENCE_NOT_FOUND_ERROR ->
                    EntitlementsSequenceNotFoundException(
                        message,
                    )
                GRAPHQL_ERROR_ENTITLEMENTS_SEQUENCE_UPDATE_IN_PROGRESS_ERROR ->
                    EntitlementsSequenceUpdateInProgressException(
                        message,
                    )
                GRAPHQL_ERROR_ENTITLEMENTS_SET_IMMUTABLE_ERROR ->
                    EntitlementsSetImmutableException(
                        message,
                    )
     ...
     */
    class BulkOperationDuplicateUsersException(
        message: String? = null,
        cause: Throwable? = null,
    ) : SudoEntitlementsAdminException(message = message, cause = cause)
     ...
     */
    class DuplicateEntitlementException(
        message: String? = null,
        cause: Throwable? = null,
    ) : SudoEntitlementsAdminException(message = message, cause = cause)
     ...
     */
    class EntitlementsSequenceUpdateInProgressException(
        message: String? = null,
        cause: Throwable? = null,
    ) : SudoEntitlementsAdminException(message = message, cause = cause)
     ...
     */
    class EntitlementsSetAlreadyExistsException(
        message: String? = null,
        cause: Throwable? = null,
    ) : SudoEntitlementsAdminException(message = message, cause = cause)
     ...
     * (e.g. _unentitled_).
     */
    class EntitlementsSetImmutableException(
        message: String? = null,
        cause: Throwable? = null,
    ) : SudoEntitlementsAdminException(message = message, cause = cause)
     ...
     */
    class EntitlementsSetInUseException(
        message: String? = null,
        cause: Throwable? = null,
    ) : SudoEntitlementsAdminException(message = message, cause = cause)
     ...
     */
    class InvalidEntitlementsException(
        message: String? = null,
        cause: Throwable? = null,
    ) : SudoEntitlementsAdminException(message = message, cause = cause)
     ...
     */
    class NegativeEntitlementException(
        message: String? = null,
        cause: Throwable? = null,
    ) : SudoEntitlementsAdminException(message = message, cause = cause)
     ...
     */
    class OverflowedEntitlementException(
        message: String? = null,
        cause: Throwable? = null,
    ) : SudoEntitlementsAdminException(message = message, cause = cause)

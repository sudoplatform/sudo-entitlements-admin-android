...
class SudoEntitlementsAdminClientUnitTest {
        ...
        this.client =
            spy(
                SudoEntitlementsAdminClient
                    .builder(appContext, "dummy_api_key")
    ...
    @Test
    fun testApplyEntitlementsSetToUser() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.mutate<String>(
    ...
    @Test
    fun testApplyEntitlementsSetToUsers() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.mutate<String>(
    ...
    @Test
    fun testGetEntitlementsSequence() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.query<String>(
    ...
    @Test
    fun testAddEntitlementsSequence() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.mutate<String>(
    ...
    @Test
    fun testSetEntitlementsSequence() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.mutate<String>(
    ...
    @Test
    fun testRemoveEntitlementsSequence() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.mutate<String>(
    ...
    @Test
    fun testApplyEntitlementsSequenceToUser() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.mutate<String>(
    ...
    @Test
    fun testApplyEntitlementsSequenceToUsers() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.mutate<String>(
    ...
    @Test
    fun testApplyEntitlementsToUser() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.mutate<String>(
    ...
    @Test
    fun testApplyEntitlementsToUsers() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.mutate<String>(
    ...
    @Test
    fun testApplyExpendableEntitlementsToUser() =
        runBlocking {
            val mockOperation: GraphQLOperation<String> = mock()
            whenever(
                this@SudoEntitlementsAdminClientUnitTest.apiCategory.mutate<String>(
        ...
        runBlocking {
            ...
            val expectedErrors =
                mapOf(
                    ...
                    "sudoplatform.entitlements.BulkOperationDuplicateUsersError" to
                        SudoEntitlementsAdminException.BulkOperationDuplicateUsersException().javaClass,
                    "sudoplatform.entitlements.DuplicateEntitlementError" to
                        SudoEntitlementsAdminException.DuplicateEntitlementException().javaClass,
                    "sudoplatform.entitlements.EntitlementsSetImmutableError" to
                        SudoEntitlementsAdminException.EntitlementsSetImmutableException().javaClass,
                    "sudoplatform.entitlements.EntitlementsSetInUseError" to
                        SudoEntitlementsAdminException.EntitlementsSetInUseException().javaClass,
                    "sudoplatform.entitlements.EntitlementsSetNotFoundError" to
                        SudoEntitlementsAdminException.EntitlementsSetNotFoundException().javaClass,
                    "sudoplatform.entitlements.EntitlementsSequenceAlreadyExistsError" to
                        SudoEntitlementsAdminException.EntitlementsSequenceAlreadyExistsException().javaClass,
                    "sudoplatform.entitlements.EntitlementsSequenceNotFoundError" to
                        SudoEntitlementsAdminException.EntitlementsSequenceNotFoundException().javaClass,
                    "sudoplatform.entitlements.EntitlementsSequenceUpdateInProgressError" to
                        SudoEntitlementsAdminException.EntitlementsSequenceUpdateInProgressException().javaClass,
                    "sudoplatform.entitlements.InvalidEntitlementsError" to
                        SudoEntitlementsAdminException.InvalidEntitlementsException().javaClass,
                    "sudoplatform.entitlements.NegativeEntitlementError" to
                        SudoEntitlementsAdminException.NegativeEntitlementException().javaClass,
                )
